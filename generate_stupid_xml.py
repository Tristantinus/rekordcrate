#!/usr/bin/env python3
"""Generate rekordbox XML from playlists-stupid M3U files, with ID3 metadata."""
...
M3U_ROOT   = r'C:\Users\trist\Desktop\playlists-stupid-m3u'
OUTPUT_XML = r'C:\Users\trist\Desktop\playlists-stupid\rekordbox_stupid.xml'
...
for tid in sorted(track_info.keys()):
    ...
    for attr in TRACK_ATTR_ORDER[1:]:
...
stupid_node  = ET.SubElement(root_node,   'NODE', Type='0', Name='Stupid Drive Playlists')
build_tree(stupid_node, (), playlists)
stupid_node.set('Count', str(len(list(stupid_node))))
